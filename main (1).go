...
func isVideoLikeMime(mimeType string) bool {
	...
	return strings.HasPrefix(mimeType, "video/") ||
		mimeType == "application/octet-stream" // many .mkv uploads land here
}
...
func (a *App) onCommand(ctx context.Context, msg *tgbotapi.Message) {
	...
	case "processlang":
		...
		if !isVideoLikeMime(rec.MimeType) {
...
func (a *App) onFile(ctx context.Context, msg *tgbotapi.Message) {
	...
	if a.cfg.AudioLangProcessingEnabled && isVideoLikeMime(fi.mimeType) && fi.fileSize > 0 {
