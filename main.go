...
func loadConfig() (*Config, error) {
	...
	cfg.AudioLangMaxFileSize = int64(envInt("AUDIO_LANG_MAX_FILE_MB", 2500)) * 1024 * 1024
...
func (a *App) onFile(ctx context.Context, msg *tgbotapi.Message) {
	...
	if a.cfg.AudioLangProcessingEnabled && isVideoLikeMime(fi.mimeType) && fi.fileSize > 0 && fi.fileSize <= a.cfg.AudioLangMaxFileSize {
