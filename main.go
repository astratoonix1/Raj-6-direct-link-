...
func (db *DB) getFileByID(ctx context.Context, id string) (*FileRecord, error) {
	...
	err := db.pool.QueryRow(ctx, `
		SELECT id,message_id,channel_id,file_name,file_size,mime_type,hash,uploader_id,uploader_name,created_at,expires_at,view_count,password_hash,password_plain,subject,chapter
